...
class Restaurant(models.Model):
    ...
    website = models.URLField(max_length=64, unique=True, null=True, blank=True)
...
class Rating(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='ratings_by_user')
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE, related_name="ratings_for_restaurant")
